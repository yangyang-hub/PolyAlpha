...
const FIELD_HINTS: Record<string, Record<string, string>> = {
  ...
  crypto_alpha: {
    ...
    next_day_alt_range_bad_exit_cooldown_trigger_count: "次日期限山寨币区间盘坏退出熔断触发次数",
    next_day_alt_range_bad_exit_cooldown_secs: "次日期限山寨币区间盘坏退出熔断窗口秒数",
    auto_apply_cooldown_priority_patch: "后端自动热应用熔断优先 patch",
    auto_apply_cooldown_priority_patch_interval_secs: "后端自动热应用熔断优先 patch 间隔秒数",
    auto_apply_cooldown_priority_patch_tighten_only: "后端自动 patch 仅允许收紧",
    auto_apply_cooldown_priority_patch_max_rows: "后端单次自动 patch 最大改动行数",
    auto_apply_cooldown_priority_patch_min_reapply_secs: "同一 bucket 自动 patch 最小重应用间隔秒数",
    ...
    same_day_major_range_probability_multiplier: "当日期限主流币区间盘额外概率收缩乘数",
    ...
    same_day_major_range_size_multiplier: "当日期限主流币区间盘额外仓位乘数",
    same_day_eth_range_size_multiplier: "当日期限 ETH 区间盘额外仓位乘数",
    ...
    same_day_major_range_min_edge_multiplier: "当日期限主流币区间盘额外最小 edge 乘数",
    ...
    next_day_alt_range_max_spread_multiplier: "次日期限山寨币区间盘额外最大价差乘数",
    ...
    same_day_major_range_capital_efficiency_multiplier: "当日期限主流币区间盘额外资金效率乘数",
    same_day_eth_range_capital_efficiency_multiplier: "当日期限 ETH 区间盘额外资金效率乘数",
    same_day_eth_range_exit_buffer_multiplier: "当日期限 ETH 区间盘额外模型反转缓冲乘数",
    ...
    same_day_major_range_hold_edge_multiplier: "当日期限主流币区间盘额外持仓最小 edge 乘数",
    same_day_eth_range_hold_edge_multiplier: "当日期限 ETH 区间盘额外持仓最小 edge 乘数",
