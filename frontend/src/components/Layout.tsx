...
const navItems = [
  { to: "/", label: "仪表板", icon: DashboardIcon },
  { to: "/weather", label: "天气策略", icon: WeatherIcon },
  { to: "/smart-money", label: "跟单交易", icon: SmartMoneyIcon },
  { to: "/lr", label: "LR奖励", icon: LRIcon },
  { to: "/crypto", label: "加密市场", icon: CryptoIcon },
    ...
    <div className="drawer lg:drawer-open">
      ...
      <div className="drawer-content flex flex-col min-h-screen">
        ...
        <div className="navbar bg-base-200 lg:hidden">
          ...
          <span className="text-lg font-bold ml-2">PolyAlpha</span>
        </div>
      ...
      <div className="drawer-side z-40">
        ...
        <aside className="bg-base-200 w-64 min-h-screen flex flex-col">
          ...
          <div className="p-4 text-xs opacity-50 border-t border-base-300">
            v2.0
          </div>
        </aside>
      </div>
